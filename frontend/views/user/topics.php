...
<div class="container main-container">
    <div class="users-show  row">
        ...
        <a href="https://phphub.org/categories/5" title="分享"> 分享 </a>
              ...
              title=""><?=date("Y-m-d H:i:s", $value->created_at);?></span>
                    ...
                    <div class="pull-right add-padding-vertically">
                        <ul class="pagination">
                            ...
                            <li><a href="https://phphub.org/users/1/topics?page=2">2</a></li>
                            <li><a href="https://phphub.org/users/1/topics?page=3">3</a></li>
                            <li><a href="https://phphub.org/users/1/topics?page=10">10</a></li>
                            <li><a href="https://phphub.org/users/1/topics?page=11">11</a></li>
                            <li><a href="https://phphub.org/users/1/topics?page=2" rel="next">»</a></li>
                        </ul>
                    </div>
