        ...
        <div class="main-col col-md-9 left-col">
                ...
                <div class="panel-body remove-padding-vertically remove-padding-horizontal">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            ...
                            <a href="https://phphub.org/topics/2751" title="<?=$value->topic->title;?>" class="remove-padding-left">
                                <?=$value->topic->title;?>
                            </a>
                            <span class="meta">
         at <span class="timeago popover-with-html" title="" data-content="<?=date("Y-m-d H:i:s", $value->created_at);?>" data-original-title="<?=date("Y-m-d H:i:s", $value->created_at);?>">2小时前</span>
                            ...
                            <div class="reply-body markdown-reply content-body">
                                <p>
                                    <a href="https://phphub.org/users/4835">@istrwei</a><br>
                                    <a href="https://phphub.org/users/5686">@Joneswong</a> 怎么了？
                                </p>
                            </div>
                    ...
                    <div class="pull-right add-padding-vertically">
                        <ul class="pagination">
                            ...
                            <li><a href="https://phphub.org/users/1/replies?page=2">2</a></li>
                            <li><a href="https://phphub.org/users/1/replies?page=3">3</a></li>
                            <li><a href="https://phphub.org/users/1/replies?page=4">4</a></li>
                            <li><a href="https://phphub.org/users/1/replies?page=5">5</a></li>
                            <li><a href="https://phphub.org/users/1/replies?page=6">6</a></li>
                            <li><a href="https://phphub.org/users/1/replies?page=7">7</a></li>
                            <li><a href="https://phphub.org/users/1/replies?page=8">8</a></li>
                            <li class="disabled"><span>...</span></li>
                            <li><a href="https://phphub.org/users/1/replies?page=82">82</a></li>
                            <li><a href="https://phphub.org/users/1/replies?page=83">83</a></li> <li><a href="https://phphub.org/users/1/replies?page=2" rel="next">»</a></li>
                        </ul>
                    </div>
